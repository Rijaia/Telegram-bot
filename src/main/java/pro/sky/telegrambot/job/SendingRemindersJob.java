...
public class SendingRemindersJob {
    ...
    private final Logger logger = LoggerFactory.getLogger(SendingRemindersJob.class);
    ...
    public void sendReminders() {
        ...
        notifications.forEach(notificationTask -> {
            ...
            telegramBotSender.send(
                    ...
                    "Напоминание! "+notificationTask.getMassage());

        });
        logger.info("SendingRemindersJob finished, {} notifications have been processed", notifications.size());
